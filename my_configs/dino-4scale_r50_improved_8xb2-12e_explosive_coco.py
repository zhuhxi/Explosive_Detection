...
test_evaluator = dict(
    ann_file='data/explosive_coco/annotations/instances_val.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
...
work_dir = './work_dirs/dino-4scale_r50_improved_8xb2-12e_explosive_coco'
