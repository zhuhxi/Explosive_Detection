...
data_root = 'data/fewshot_voc/VOCdevkit/'
data = dict(
    samples_per_gpu=2,
    workers_per_gpu=2,
    train=dict(
        ...
        ann_cfg=[
            dict(
                type='ann_file',
                ann_file=
                'data/fewshot_voc/VOCdevkit/VOC2007/ImageSets/Main/trainval.txt'
            )
        ],
        img_prefix='data/fewshot_voc/VOCdevkit/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(
    ...
    val=dict(
        ...
        ann_cfg=[
            dict(
                type='ann_file',
                ann_file=
                'data/fewshot_voc/VOCdevkit/VOC2007/ImageSets/Main/test.txt')
        ],
        img_prefix='data/fewshot_voc/VOCdevkit/',
        pipeline=[
            dict(type='LoadImageFromFile'),
