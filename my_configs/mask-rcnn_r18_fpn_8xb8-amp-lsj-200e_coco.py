...
test_evaluator = dict(
    ann_file='data/tiny1_coco//annotations/instances_val2017.json',
    backend_args=None,
    format_only=False,
    metric=[
        'bbox',
...
train_cfg = dict(max_epochs=1000, type='EpochBasedTrainLoop', val_interval=5)
...
work_dir = './work_dirs/mask-rcnn_r18_fpn_8xb8-amp-lsj-200e_coco'
