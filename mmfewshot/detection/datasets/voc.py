...
VOC_SPLIT = dict(
    ALL_CLASSES_SPLIT1=("Battery", "Explosive", "Backpack", "Spoon", "Organic Item", 
                        "Cable", "Fork", "Electronic Device", "Hangers", "Umbrella", 
                        "Electrical Device", "Screwdriver", "Hammer", "Pan", "Jumper cable", 
                        "Box of springs", "Metallic Item", "Plate", "Box", "Laptop charger", 
                        "Metallic bottle", "Bolts", "Grid", "Headset", "Can", "Egg Beater", 
                        "Suitcase", "Suitcase trolley bar", "Plastic bottle", "Belt", "Jewelry", 
                        "Mouse", "Laptop", "Keys", "Chain", "Stack of coins", "explosive"),
    ...
    NOVEL_CLASSES_SPLIT1=('explosive', 'explosive'),
    # NOVEL_CLASSES_SPLIT2=('aeroplane', 'bottle', 'cow', 'horse', 'sofa'),
    # NOVEL_CLASSES_SPLIT3=('boat', 'cat', 'motorbike', 'sheep', 'sofa'),
    BASE_CLASSES_SPLIT1=("Battery", "Explosive", "Backpack", "Spoon", "Organic Item", 
                        "Cable", "Fork", "Electronic Device", "Hangers", "Umbrella", 
                        "Electrical Device", "Screwdriver", "Hammer", "Pan", "Jumper cable", 
                        "Box of springs", "Metallic Item", "Plate", "Box", "Laptop charger", 
                        "Metallic bottle", "Bolts", "Grid", "Headset", "Can", "Egg Beater", 
                        "Suitcase", "Suitcase trolley bar", "Plastic bottle", "Belt", "Jewelry", 
                        "Mouse", "Laptop", "Keys", "Chain", "Stack of coins"),
...
class FewShotVOCDefaultDataset(FewShotVOCDataset):
    ...
    voc_benchmark = {
        f'SPLIT{split}_{shot}SHOT': [
            dict(
                type='ann_file',
                ann_file=f'data/fewshot_voc/few_shot_ann/voc/benchmark_{shot}shot/'
                f'box_{shot}shot_{class_name}_train.txt',
                ann_classes=[class_name])
            for class_name in VOC_SPLIT[f'NOVEL_CLASSES_SPLIT{split}']
        ]
